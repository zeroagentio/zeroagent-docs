...
| **List the Folders at a Given Path** | Retrieves a list of folders at a specified path. _Note: For root path specific empty string_ | `List folders in path 'Homework' directory`                                                                                |
...
| **Show folder contents**     | Retrieves all contents in a specific folder                 | `Show all content in 'maths' folder` |
